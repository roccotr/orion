...
int main(int argc, char** argv) {
    ...
    const std::string DATA_PATH = "./orionfoldernew/test/";
    const std::string LOG_PATH = "/Users/sommoyogurt/Desktop/templog";
    ...
    //BENCHMARK L1
    {
        ...
        DB::DestroyDB (options, DATA_PATH);
        db = DB::Open (options, DATA_PATH);
