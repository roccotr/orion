...
#define iVwrites 1000000
        ...
        tVend = __Time();
        std::cout << iVwrites;
        std::cout << std::setw(10)<<"insert forward meot";
        double dVqpsmeot = (double) iVwrites / (tVdiff * (tVend - tVstart));
        std::cout << std::setw(10) << tVdiff * (tVend - tVstart) << std::setw(10) << "qps " << dVqpsmeot << std::endl;
        ...
        printf("%i insert forward L1:    %f, qps %f\n", iVwrites, tVdiff * (tVend - tVstart),
               (double) iVwrites / (tVdiff * (tVend - tVstart)));
